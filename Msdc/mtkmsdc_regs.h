...
#define MSDC_PB2_RESPWAIT_MASK  0x0000000c
#define MSDC_PB2_CFGRESP        MTK_BIT(15)
#define MSDC_PB2_CFGCRCSTS      MTK_BIT(28)
#define MSDC_TOP_CTRL           0x000
#define MSDC_TOP_CMD            0x004
#define MSDC_TOP_PAD_DAT_RD_RXDLY_SEL MTK_BIT(13)
#define MSDC_TOP_DATA_K_VALUE_SEL    MTK_BIT(14)
#define MSDC_TOP_SDC_RX_ENH_EN       MTK_BIT(15)
#define MSDC_TOP_PAD_CMD_RD_RXDLY_SEL MTK_BIT(11)

#define MTK_MSDC_REQUIRED_MMIO_LENGTH 0x22cUL
#define MTK_MSDC0_BASE                0x11230000ULL
#define MTK_MSDC1_BASE                0x11240000ULL
#define MTK_MSDC_TOP0_BASE            0x11CD0000ULL
#define MTK_MSDC_TOP1_BASE            0x11C90000ULL
